...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DocumentReference">
      <sch:assert test="count(f:extension[@url = 'https://sns.gob.es/fhir/hcdsns/StructureDefinition/patient-flag-oculto']) &lt;= 1">extension with URL = 'https://sns.gob.es/fhir/hcdsns/StructureDefinition/patient-flag-oculto': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://sns.gob.es/fhir/hcdsns/StructureDefinition/patient-operacion']) &lt;= 1">extension with URL = 'https://sns.gob.es/fhir/hcdsns/StructureDefinition/patient-operacion': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:DocumentReference/f:subject/f:identifier</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DocumentReference/f:custodian</sch:title>
